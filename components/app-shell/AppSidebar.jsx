...
const NAV_ITEMS = [
  ...
  { href: "/contacts", label: "Contacts (Coming Soon)", icon: Users },
  { href: "/ai-writer", label: "AI Writer (Coming Soon)", icon: BookOpenCheck },
  { href: "/sequences", label: "Sequences (Coming Soon)", icon: Zap },
  { href: "/inbox", label: "Inbox (Coming Soon)", icon: Inbox },
];
  ...
  return (
    <aside className="w-64 border-r border-white/5 bg-obsidian-900 flex flex-col h-full sticky top-0">
      ...
      <div className="p-4 border-b border-white/5">
        <button className="w-full flex items-center justify-between bg-white/5 hover:bg-white/10 p-2 rounded-md transition-colors border border-white/5">
